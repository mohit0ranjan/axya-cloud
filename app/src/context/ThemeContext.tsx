...
const sharedTokens = {
    ...
    radius: {
        sm: 8, md: 12, button: 16, card: 16, modal: 20,
...
export const lightTheme = {
    ...
    colors: {
        ...
        purple: '#9333EA',
        neutral: {
            50: '#F8F9FC', 100: '#F1F3F9', 200: '#E2E8F0', 300: '#CBD5E1',
    ...
    shadows: {
        ...
        elevation1: { shadowColor: '#1A1F36', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 2 },
        elevation2: { shadowColor: '#1A1F36', shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.08, shadowRadius: 24, elevation: 4 },
    },
};
